package com.helpdeskeditor.application.util.ApexCharts;

import com.fasterxml.jackson.annotation.JsonInclude;
import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.helpdeskeditor.application.util.ApexCharts.config.Annotations;
import com.helpdeskeditor.application.util.ApexCharts.config.Chart;
...
import com.helpdeskeditor.application.util.ApexCharts.config.Grid;
import com.helpdeskeditor.application.util.ApexCharts.config.Legend;
import com.helpdeskeditor.application.util.ApexCharts.config.Markers;
import com.helpdeskeditor.application.util.ApexCharts.config.NoData;
import com.helpdeskeditor.application.util.ApexCharts.config.PlotOptions;
...
import com.helpdeskeditor.application.util.ApexCharts.config.Stroke;
...
import com.helpdeskeditor.application.util.ApexCharts.config.Tooltip;
import com.helpdeskeditor.application.util.ApexCharts.config.XAxis;
import com.helpdeskeditor.application.util.ApexCharts.config.YAxis;
...
@JsModule("./apexcharts/apexcharts-wrapper.ts")
@CssImport(value = "./apexcharts/apexcharts-wrapper-styles.css", id = "apex-charts-style")
